...
namespace ADeeWu.HuoBi3J.DAL
{
    ...
    public class CP_Keyword_Result_Click
    {
        ...
        public bool Exist(string where)
        {
            ...
            builder.Append("select * from [CP_Keyword_Result_Click] where 1=1");
        ...
        /// 成功返回大于0的新ID
        /// </summary>
        public long Add(ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click model)
        {
            db.Parameters.Clear();
            db.Parameters.Append("@KeywordResultID", model.KeywordResultID.HasValue ? (object)model.KeywordResultID.Value : (object)DBNull.Value);
            db.Parameters.Append("@ClickTime", model.ClickTime.HasValue ? (object)model.ClickTime.Value : (object)DBNull.Value);
            db.Parameters.Append("@ClickIP", model.ClickIP);
            DataTable dt = db.Select("insert into [CP_Keyword_Result_Click]([KeywordResultID],[ClickTime],[ClickIP]) values (@KeywordResultID,@ClickTime,@ClickIP);select @@Identity;");
            long newID = long.Parse(dt.Rows[0][0].ToString());
            model.ID = newID;
            return newID;
        }

        public int Update(ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click model)
        {
            db.Parameters.Clear();
            ...
            db.Parameters.Append("@ClickTime", model.ClickTime.HasValue ? (object)model.ClickTime.Value : (object)DBNull.Value);
            db.Parameters.Append("@ClickIP", model.ClickIP);
            return db.ExecuteSql("update [CP_Keyword_Result_Click] set [KeywordResultID]=@KeywordResultID,[ClickTime]=@ClickTime,[ClickIP]=@ClickIP where [ID]=@ID");
        }
        ...
        {
            string sql = String.Format("update [{0}] set {1}=@{1}", "CP_Keyword_Result_Click", columnName);
        ...
        public int Update(string[] updateColumns, object[] updateValues, string where)
        {
            ...
            string sql = String.Format("update [{0}] ", "CP_Keyword_Result_Click");
        ...
        public int Delete(long ID)
        {
            ...
            return db.ExecuteSql("delete from [CP_Keyword_Result_Click]  where  @ID=ID");
        }
        ...
        {
            string sql = string.Format("delete from [{0}] ", "CP_Keyword_Result_Click");
            return db.ExecuteSql(sql);
        ...
        {
            string sql = string.Format("delete from [{0}] where 1=2 ", "CP_Keyword_Result_Click");
            if (string.IsNullOrEmpty(where))
            {
                return -1;
            }
        ...
        {
            string sql = string.Format("delete from [{0}] where {1}=@{1} ", "CP_Keyword_Result_Click", columnName);
            db.Parameters.Clear();
            db.Parameters.Append("@" + columnName, value);
            return db.ExecuteSql(sql);
        }

        public ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click GetEntity(long ID)
        {
            db.Parameters.Clear();
            db.Parameters.Append("@ID", ID);
            DataTable dt = db.Select("select * from [CP_Keyword_Result_Click] where 1=1  and [ID]=@ID");
            if (dt.Rows.Count == 0) return null;
            DataRow dr = dt.Rows[0];
            ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click Entity = new ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click();
            Entity.ID = long.Parse(dr["ID"].ToString());
            Entity.KeywordResultID = dr["KeywordResultID"] as long?;
            Entity.ClickTime = dr["ClickTime"] as DateTime?;
            Entity.ClickIP = dr["ClickIP"] as string;
            return Entity;
        }


        public ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click GetEntity(string[] columns, params object[] values)
        {
            ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click[] EntityList = GetEntityList("", columns, values);
            if (EntityList.Length == 0) return null;
            return EntityList[0];
        }

        public ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click GetEntity(string where)
        {
        ...
        public ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click[] GetEntityList(string orderBy, string[] columns, params object[] values)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select * from [CP_Keyword_Result_Click] where 1=1");
            db.Parameters.Clear();
            ...
            ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click[] EntityList = new ADeeWu.HuoBi3J.Model.CP_Keyword_Result_Click[dt.Rows.Count];
        ...
        {
            return db.Select(-1, -1, "CP_Keyword_Result_Click", "ID", where, orderBy);
        }
        ...
        {
            return db.Select(pageSize, pageIndex, "CP_Keyword_Result_Click", "ID", "", "");
        }
        ...
        {
            return db.Select(pageSize, pageIndex, "CP_Keyword_Result_Click", "ID", "", orderBy);
        }
        ...
        {
            return db.Select(pageSize, pageIndex, "CP_Keyword_Result_Click", "ID", where, orderBy);
        }
