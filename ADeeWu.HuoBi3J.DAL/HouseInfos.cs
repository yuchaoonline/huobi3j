...
namespace ADeeWu.HuoBi3J.DAL
{
    ...
    public class HouseInfos
    {
        ...
        public bool Exist(string where)
        {
            ...
            builder.Append("select * from [HouseInfos] where 1=1");
        ...
        /// 成功返回大于0的新ID
        /// </summary>
        public long Add(ADeeWu.HuoBi3J.Model.HouseInfos model)
        {
            db.Parameters.Clear();
            db.Parameters.Append("@UserID", model.UserID);
            db.Parameters.Append("@HomeCode", model.HomeCode);
            db.Parameters.Append("@Title", model.Title);
            db.Parameters.Append("@Content", model.Content);
            db.Parameters.Append("@Properity", model.Properity);
            db.Parameters.Append("@HouseType", model.HouseType);
            db.Parameters.Append("@HouseStructValue", model.HouseStructValue);
            db.Parameters.Append("@HouseStructText", model.HouseStructText);
            ...
            db.Parameters.Append("@BusLine", model.BusLine);
            db.Parameters.Append("@AreaSize", model.AreaSize);
            ...
            db.Parameters.Append("@UpdateTime", model.UpdateTime);
            db.Parameters.Append("@VisitCount", model.VisitCount);
            db.Parameters.Append("@Lat", model.Lat);
            db.Parameters.Append("@Lng", model.Lng);
            ...
            DataTable dt = db.Select("insert into [HouseInfos]([UserID],[HomeCode],[Title],[Content],[Properity],[HouseType],[HouseStructValue],[HouseStructText],[Province],[City],[Area],[ProvinceID],[CityID],[AreaID],[Address],[BusLine],[AreaSize],[Price],[EndTime],[CheckState],[CreateTime],[UpdateTime],[VisitCount],[Lat],[Lng],[LinkName],[LinkPhone],[LinkEmail]) values (@UserID,@HomeCode,@Title,@Content,@Properity,@HouseType,@HouseStructValue,@HouseStructText,@Province,@City,@Area,@ProvinceID,@CityID,@AreaID,@Address,@BusLine,@AreaSize,@Price,@EndTime,@CheckState,@CreateTime,@UpdateTime,@VisitCount,@Lat,@Lng,@LinkName,@LinkPhone,@LinkEmail);select @@Identity;");
            long newID = long.Parse(dt.Rows[0][0].ToString());
            model.ID = newID;
            return newID;
        }

        public int Update(ADeeWu.HuoBi3J.Model.HouseInfos model)
        {
            db.Parameters.Clear();
            ...
            db.Parameters.Append("@LinkPhone", model.LinkPhone);
            db.Parameters.Append("@LinkEmail", model.LinkEmail);
            return db.ExecuteSql("update [HouseInfos] set [UserID]=@UserID,[HomeCode]=@HomeCode,[Title]=@Title,[Content]=@Content,[Properity]=@Properity,[HouseType]=@HouseType,[HouseStructValue]=@HouseStructValue,[HouseStructText]=@HouseStructText,[Province]=@Province,[City]=@City,[Area]=@Area,[ProvinceID]=@ProvinceID,[CityID]=@CityID,[AreaID]=@AreaID,[Address]=@Address,[BusLine]=@BusLine,[AreaSize]=@AreaSize,[Price]=@Price,[EndTime]=@EndTime,[CheckState]=@CheckState,[CreateTime]=@CreateTime,[UpdateTime]=@UpdateTime,[VisitCount]=@VisitCount,[Lat]=@Lat,[Lng]=@Lng,[LinkName]=@LinkName,[LinkPhone]=@LinkPhone,[LinkEmail]=@LinkEmail where [ID]=@ID");
        }
        ...
        {
            string sql = String.Format("update [{0}] set {1}=@{1}", "HouseInfos", columnName);
        ...
        public int Update(string[] updateColumns, object[] updateValues, string where)
        {
            ...
            string sql = String.Format("update [{0}] ", "HouseInfos");
        ...
        public int Delete(long ID)
        {
            ...
            return db.ExecuteSql("delete from [HouseInfos]  where  @ID=ID");
        }
        ...
        {
            string sql = string.Format("delete from [{0}] ", "HouseInfos");
            return db.ExecuteSql(sql);
        ...
        {
            string sql = string.Format("delete from [{0}] where 1=2 ", "HouseInfos");
            if (string.IsNullOrEmpty(where))
            {
                return -1;
            }
        ...
        {
            string sql = string.Format("delete from [{0}] where {1}=@{1} ", "HouseInfos", columnName);
            db.Parameters.Clear();
            db.Parameters.Append("@" + columnName, value);
            return db.ExecuteSql(sql);
        }

        public ADeeWu.HuoBi3J.Model.HouseInfos GetEntity(long ID)
        {
            db.Parameters.Clear();
            db.Parameters.Append("@ID", ID);
            DataTable dt = db.Select("select * from [HouseInfos] where 1=1  and [ID]=@ID");
            if (dt.Rows.Count == 0) return null;
            DataRow dr = dt.Rows[0];
            ADeeWu.HuoBi3J.Model.HouseInfos Entity = new ADeeWu.HuoBi3J.Model.HouseInfos();
            Entity.ID = long.Parse(dr["ID"].ToString());
            Entity.UserID = long.Parse(dr["UserID"].ToString());
            Entity.HomeCode = (string)(dr["HomeCode"]);
            Entity.Title = (string)(dr["Title"]);
            Entity.Content = (string)(dr["Content"]);
            Entity.Properity = int.Parse(dr["Properity"].ToString());
            Entity.HouseType = int.Parse(dr["HouseType"].ToString());
            Entity.HouseStructValue = int.Parse(dr["HouseStructValue"].ToString());
            Entity.HouseStructText = (string)(dr["HouseStructText"]);
            ...
            Entity.BusLine = (string)(dr["BusLine"]);
            Entity.AreaSize = double.Parse(dr["AreaSize"].ToString());
            ...
            Entity.UpdateTime = DateTime.Parse(dr["UpdateTime"].ToString());
            Entity.VisitCount = int.Parse(dr["VisitCount"].ToString());
            Entity.Lat = double.Parse(dr["Lat"].ToString());
            Entity.Lng = double.Parse(dr["Lng"].ToString());
        ...
        public ADeeWu.HuoBi3J.Model.HouseInfos GetEntity(string[] columns, params object[] values)
        {
            ADeeWu.HuoBi3J.Model.HouseInfos[] EntityList = GetEntityList("", columns, values);
            if (EntityList.Length == 0) return null;
            return EntityList[0];
        }

        public ADeeWu.HuoBi3J.Model.HouseInfos GetEntity(string where)
        {
        ...
        public ADeeWu.HuoBi3J.Model.HouseInfos[] GetEntityList(string orderBy, string[] columns, params object[] values)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select * from [HouseInfos] where 1=1");
            db.Parameters.Clear();
            ...
            ADeeWu.HuoBi3J.Model.HouseInfos[] EntityList = new ADeeWu.HuoBi3J.Model.HouseInfos[dt.Rows.Count];
        ...
        {
            return db.Select(-1, -1, "HouseInfos", "ID", where, orderBy);
        }
        ...
        {
            return db.Select(pageSize, pageIndex, "HouseInfos", "ID", "", "");
        }
        ...
        {
            return db.Select(pageSize, pageIndex, "HouseInfos", "ID", "", orderBy);
        }
        ...
        {
            return db.Select(pageSize, pageIndex, "HouseInfos", "ID", where, orderBy);
        }
