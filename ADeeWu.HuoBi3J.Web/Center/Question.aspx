            ...
            <ItemTemplate>
                <div class="centerP_body">
                    <div class="body_content font14 black70">
                        ...
                        <p class="mt10">
                            <span>提问人：<label class="black32"><%# Eval("LoginName") %></label></span><span>所属关键字：<label class="black32"><%# ADeeWu.HuoBi3J.Web.Class.Helper.GetKey(Eval("kid"),Eval("kname")) %></label></span></p>
                        <p class="mt10">
                            <span>所属商圈：<label class="black32"><%# ADeeWu.HuoBi3J.Web.Class.Helper.GetBusinessCircle(Eval("bid"),Eval("bname")) %></label></span><span>所属区域：<label class="black32"><%# ADeeWu.HuoBi3J.Web.Class.Helper.GetLocation(Eval("aid"),Eval("aname"),Eval("cid"),Eval("cname"),Eval("pid"),Eval("pname")," - ") %></label></span><%--<span>添加时间：<label class="black32"><%# Eval("createtime") %></label></span>--%></p>
                    </div>
                </div>
        ...
        <asp:Repeater ID="rpProduct" runat="server">
            <ItemTemplate>
                <div class="centerP_body">
                    <div class="body_content font14 black70">
                        <p>
                            <span>商品名称：<label class="black32"><%# Eval("Name") %></label></span><span>商品内容：<label class="black32"><%# Eval("Content") %></label></span><span>商品分类：<label class="black32"><%# bindCategory(Eval("categoryid")) %></label></span></p>
                        <p class="mt10">
