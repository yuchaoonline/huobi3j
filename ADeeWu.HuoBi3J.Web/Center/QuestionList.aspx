...
<asp:Content ID="Content3" ContentPlaceHolderID="main" runat="server">    
            ...
            <asp:Repeater ID="rpKey" runat="server">
                <ItemTemplate>
                    <div class="body_content font14 black70">
                        ...
                        <p class="mt10">
                            <span>操作：
                                <asp:Button ID="btnAttention" runat="server" Text="关注" OnClick="btnAttention_Click" CssClass="btn_blue btnAttention" Style="display: none;" />
    ...
    <div class="item">
        <div id="PostQustion" style="display: none; float: left;">
            ...
            <textarea name="content" id="content" style="width: 800px; height: 34px;"></textarea>
            <br />
            ...
            <div id="productCategory" style="display: none">
                ...
                <br />
                商品名称：<input type="text" name="productName" />&nbsp;&nbsp;&nbsp;<button id="searchProduct" class="btn_blue89">搜索产品</button>
                <br />
                选择商品：<select id="productID"><option value="-1">请选择</option></select>
                <br />
                <p>
