<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucFooter.ascx.cs" Inherits="ADeeWu.HuoBi3J.Web.Controls.ucFooter" %>
<!--footer-->
<div id="footer">
    <div>
    ...
    <p>
        Copyright© 2009-2010 www.ADeeWu.HuoBi3J.com All Rights Reserved 全民营销网 版权所有.<br>
        未经许可，不得擅自复制本网站内容！ 粤ICP备10071024号
    </p>
