<%@ Page Language="C#" Title="" MasterPageFile="~/MMyCorp.master" CodeBehind="New.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.My.Corp.ProductCategories.New" %>
...
<span class="spl">　</span><a href="/My/Corp/Shop/">在线营销</a><span class="spl">　</span><a href="/My/Corp/Shop/ProductCategories/">商铺产品分类</a><span class="spl">　</span><span class="curPos">添加</span>
  </asp:Content>
...
<table class="formTable">
    ...
    <tr>
        ...
        <td class="tdRight">
            <asp:Button ID="btnSubmit" runat="server" Text="添加分类" 
