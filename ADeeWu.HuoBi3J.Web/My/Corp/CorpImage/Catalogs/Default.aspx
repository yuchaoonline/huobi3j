<%@ Page Language="C#" Title="" MasterPageFile="~/MMyCorp.master" CodeBehind="Default.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.My.Corp.CorpImage.Catalogs.Default" %>
    ...
    <tr>       
         <td class="key" style="width:70px">
            ...
            <td>
                ...
                <asp:Button ID="btnSubmit" runat="server" Text="搜索" onclick="btnSubmit_Click" /> <a href="New.aspx">添加画册</a>
            </td>
...
<Columns>
    ...
    <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="col_option" ItemStyle-CssClass="col_option"> <ItemTemplate>
                    <a href='CatalogPhotos/Default.aspx?id=<%#Eval("ID") %>'>查看|</a>  
