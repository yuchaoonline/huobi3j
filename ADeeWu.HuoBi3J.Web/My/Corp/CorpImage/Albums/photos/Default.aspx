<%@ Page Language="C#" Title="" MasterPageFile="~/MMyCorp.master" CodeBehind="Default.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.My.Corp.CorpImage.Albums.Photos.Default" %>
...
<span class="spl">　</span><a href="/My/Corp/CorpImage/Albums/">企业相册</a><span class="spl">　</span><span class="curPos">企业相册图片</span>
      </asp:Content>
    ...
    <Columns>
        ...
        <%--<asp:TemplateField   HeaderText="编号">     
          ...
          <asp:TemplateField HeaderText="图片">
            <ItemTemplate>
                <img src="<%# Eval("URL")%>" onload="isc.util.zoomImg(this,140,120);" />
            </ItemTemplate>   
            </asp:TemplateField>
        ...
        <ItemTemplate>
        <a herf="../Edit.aspx?id=<%#Eval("AlbumID") %>"><%#Eval("AlbumName") %></a>         
         </ItemTemplate>
        </asp:TemplateField>
