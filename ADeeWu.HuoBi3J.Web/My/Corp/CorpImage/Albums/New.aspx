<%@ Page Language="C#" Title="" MasterPageFile="~/MMyCorp.master" CodeBehind="New.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.My.Corp.CorpImage.Albums.New" %>
...
<span class="spl">　</span><a href="/My/Corp/CorpImage/Albums/">企业相册</a><span class="spl">　</span><span class="curPos">新建相册</span> 
  </asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="server">
 ...
 <table border="0" cellspacing="0" cellpadding="0" class="formTable">
  ...
  <tr >        
		<td class="tdLeft">
              <asp:Button ID="btnSubmit" runat="server" Text="发布相册"  
