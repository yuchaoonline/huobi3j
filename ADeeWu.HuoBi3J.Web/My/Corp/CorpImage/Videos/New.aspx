<%@ Page Language="C#" Title="" MasterPageFile="~/MMyCorp.master" CodeBehind="New.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.My.Corp.CorpImage.Videos.New" %>
...
<span class="spl">　</span><a href="/My/Corp/CorpImage/Videos/">企业视频</a><span class="spl">　</span><span class="curPos">添加视频</span> 
  </asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="server">
 ...
 <table border="0" cellspacing="0" cellpadding="0" class="formTable">
  <tr>
   ...
   <tr>
    ...
    <td class="tdRight" id="TDSelectVideo">
        ...
        <div>
            <asp:RadioButton ID="rbtnUpload" runat="server" Text="上传视频" GroupName="selectVideo" Checked="true" />
			<span>
  ...
  <tr>
   ...
   <tr >        
		<td class="tdLeft">
              <asp:Button ID="btnSubmit" runat="server" Text="发布视频"  
