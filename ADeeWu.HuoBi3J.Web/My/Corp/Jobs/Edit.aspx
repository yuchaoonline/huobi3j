<%@ Page Language="C#" Title="" MasterPageFile="~/MMyCorp.master" CodeBehind="Edit.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.My.Corp.Jobs.Edit" %>
...
<span class="spl">　</span><a href="/My/Corp/Jobs/">招聘管理</a><span class="spl">　</span><span class="curPos">修改职位信息</span>
  </asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="server">
    ...
    <table border="0" cellpadding="0" cellspacing="0">
           <tr >
               ...
               <td colspan="2" class="tdRight"><input name="jobName" type="text"   id="jobName" size="38" runat="server"/>
                <span class="require">*</span></td>
           </tr>  
           <tr>
              <td align="left">所在区域：</td>
           ...
           <tr>
             ...
             <td class="tdRight">
               <input name="MonthlyPay" runat="server"  onkeyup="value=value.replace(/[^\d]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" type="text" id="MonthlyPay" size="10" /> 
                元
				<span class="require">*</span><span class="tips">输入0表示 "面议" </span>
				</td>
             <td class="tdRight">&nbsp;</td>
           </tr>
           <tr>
