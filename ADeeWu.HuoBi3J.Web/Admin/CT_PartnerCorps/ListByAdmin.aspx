<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Admin/MAdmin.master" CodeBehind="ListByAdmin.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.Admin.CT_PartnerCorps.ListByAdmin"  %>
...
<span>现金券合作商家管理</span> &gt; 合作商家列表[统计] <%--| <a href="Add.aspx">添加(开通现金券服务)</a>--%>
</asp:Content>
