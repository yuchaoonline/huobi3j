<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Admin/MAdmin.master" CodeBehind="List.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.Admin.Job_Callings.List" %>
...
<span>职位行业分类管理</span> &gt; 分类列表 | <a href="Add.aspx">添加</a>
</asp:Content>
