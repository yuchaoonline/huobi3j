<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Admin/MAdmin.master" CodeBehind="Edit.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.Admin.Callings.Edit"  %>
<%@ Register Assembly="ADeeWu.HuoBi3J.WebUI" Namespace="ADeeWu.HuoBi3J.WebUI" TagPrefix="IscControl" %>



<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
Admin - Market_Categories - Edit
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">

</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="siteposition" runat="server">
<span>行业分类管理</span> &gt; 添加 | <a href="List.aspx">分类列表</a>
</asp:Content>
...
<table border="0" cellspacing="0" cellpadding="0" class="formTable">
  ...
  <tr>
    ...
    <td class="tdRight">
        <asp:TextBox ID="txtItemCount" runat="server" CssClass="txtNum" ></asp:TextBox><span class="tips">用于前台显示属于该分类的记录数</span>
    </td>
  </tr>
  <tr>
    <td class="tdLeft">推荐:</td>
    <td class="tdRight">
        <asp:CheckBox ID="chhRecommend" runat="server" Text="是" />
    </td>
  </tr>
  <tr>
