<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Admin/MAdmin.master" CodeBehind="List.aspx.cs" Inherits="ADeeWu.HuoBi3J.Web.Admin.VirtualTransfers.List"  %>
...
<span>会员帐号费用管理</span> &gt; 费用明细记录 | <a href="Add.aspx">帐户充值</a> | <a href="Sub.aspx">帐户扣费</a>
</asp:Content>
    ...
    <tr>
        ...
        <td class="input">
            <asp:DropDownList ID="ddlFilter" runat="server">
                ...
                <asp:ListItem Text="充值" Value="0"></asp:ListItem>
                <asp:ListItem Text="扣费" Value="1"></asp:ListItem>
            </asp:DropDownList>
        </td>
        <td>
